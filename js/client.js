function init() {
  ...
  //This comes from codepen: https://codepen.io/baziotabeans/pen/xxZPpjq
...
// Using window.addEventListener() and the load event, invoke this when the page has finished loading.
